  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of mobility with B2C Car Sharing - Where individual customers book nearby cars, managed seamlessly by our dedicated operations staff."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of mobility with B2C Car Sharing - Where individual customers book nearby cars, managed seamlessly by our dedicated operations staff.`}
            </Text>
            <Box
